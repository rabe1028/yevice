...
fn free_then(free: f64, unit_price: f64) -> PricedValue {
    PricedValue::tiered(
        vec![
            PricedTier {
...
impl PriceCatalog for TestCatalog {
    ...
    fn lookup(&self, sku: &Sku) -> Result<PricedValue, PricingError> {
        let price = match sku.as_str() {
            "aws.alb.alb_hour_price" => PricedValue::scalar(0.10, "USD"),
            "aws.alb.lcu_hour_price" => PricedValue::scalar(0.01, "USD"),
            "aws.api_gateway.rest_api_request_price" => PricedValue::scalar(1.0, "USD"),
            "aws.api_gateway.http_api_request_price" => PricedValue::scalar(2.0, "USD"),
            "aws.api_gateway.free_tier_requests" => PricedValue::scalar(100.0, "USD"),
            "aws.appsync.operation_price_per_million" => PricedValue::scalar(1_000_000.0, "USD"),
            "aws.appsync.free_tier_operations" => PricedValue::scalar(100.0, "USD"),
            "aws.athena.scan_price_per_tb" => PricedValue::scalar(1_000.0, "USD"),
            "aws.batch.fargate_vcpu_hour_price" => PricedValue::scalar(2.0, "USD"),
            "aws.batch.fargate_memory_gb_hour_price" => PricedValue::scalar(1.0, "USD"),
            "aws.batch.fargate_ephemeral_storage_gb_hour_price" => PricedValue::scalar(0.5, "USD"),
            "aws.batch.fargate_ephemeral_free_gb" => PricedValue::scalar(20.0, "USD"),
            "aws.batch.ebs_gp3_gb_month_price" => PricedValue::scalar(1.0, "USD"),
            "aws.batch.ebs_gp3_iops_month_price" => PricedValue::scalar(1.0, "USD"),
            "aws.batch.ebs_gp3_iops_free" => PricedValue::scalar(3_000.0, "USD"),
            "aws.batch.ebs_gp3_throughput_mibps_month_price" => PricedValue::scalar(1.0, "USD"),
            "aws.batch.ebs_gp3_throughput_free_mibps" => PricedValue::scalar(125.0, "USD"),
            "aws.cloudfront.request_price_per_10k" => PricedValue::scalar(10.0, "USD"),
            "aws.cloudfront.data_transfer_price_per_gb" => PricedValue::scalar(2.0, "USD"),
            "aws.cloudfront.free_tier_data_transfer_gb" => PricedValue::scalar(100.0, "USD"),
            "aws.cloudwatch_logs.ingestion_price_per_gb" => PricedValue::scalar(2.0, "USD"),
            "aws.cloudwatch_logs.storage_price_per_gb" => PricedValue::scalar(1.0, "USD"),
            "aws.cloudwatch_logs.free_tier_ingestion_gb" => PricedValue::scalar(10.0, "USD"),
            "aws.cloudwatch_logs.free_tier_storage_gb" => PricedValue::scalar(20.0, "USD"),
            "aws.cognito.free_tier_mau" => PricedValue::scalar(0.0, "USD"),
            "aws.cognito.tier1_price" => PricedValue::scalar(1.0, "USD"),
            "aws.cognito.tier2_price" => PricedValue::scalar(0.5, "USD"),
            "aws.cognito.tier3_price" => PricedValue::scalar(0.25, "USD"),
            "aws.dynamodb.write_request_price" => PricedValue::scalar(2.0, "USD"),
            "aws.dynamodb.read_request_price" => PricedValue::scalar(1.0, "USD"),
            "aws.dynamodb.wcu_hour_price" => PricedValue::scalar(1.0, "USD"),
            "aws.dynamodb.rcu_hour_price" => PricedValue::scalar(2.0, "USD"),
            "aws.dynamodb.storage_price_per_gb" => PricedValue::scalar(3.0, "USD"),
            "aws.dynamodb.free_tier_wru" => PricedValue::scalar(10.0, "USD"),
            "aws.dynamodb.free_tier_rru" => PricedValue::scalar(20.0, "USD"),
            "aws.dynamodb.free_tier_storage_gb" => PricedValue::scalar(5.0, "USD"),
            "aws.data_transfer.egress_tiers" => free_then(100.0, 1.0),
            "aws.ecr.private_storage_gb_month" => PricedValue::scalar(2.0, "USD"),
            "aws.fargate.vcpu_hour_price" => PricedValue::scalar(0.1, "USD"),
            "aws.fargate.memory_gb_hour_price" => PricedValue::scalar(0.01, "USD"),
            "aws.efs.standard_gb_month_price" => PricedValue::scalar(1.0, "USD"),
            "aws.efs.ia_gb_month_price" => PricedValue::scalar(0.5, "USD"),
            "aws.eks.cluster_hour_price" => PricedValue::scalar(1.0, "USD"),
            "aws.eventbridge_rule.custom_event_price_per_million" => {
                PricedValue::scalar(1_000_000.0, "USD")
            }
            "aws.eventbridge_scheduler.invocation_price" => PricedValue::scalar(2.0, "USD"),
            "aws.eventbridge_scheduler.free_tier_invocations" => PricedValue::scalar(10.0, "USD"),
            "aws.firehose.ingestion_price_per_gb" => PricedValue::scalar(3.0, "USD"),
            "aws.glue.standard_dpu_hour_price" => PricedValue::scalar(2.0, "USD"),
            "aws.glue.flex_dpu_hour_price" => PricedValue::scalar(1.0, "USD"),
            "aws.kinesis.shard_hour_price" => PricedValue::scalar(1.0, "USD"),
            "aws.kinesis.put_payload_unit_price" => PricedValue::scalar(0.5, "USD"),
            "aws.kinesis.on_demand_ingestion_price_per_gb" => PricedValue::scalar(2.0, "USD"),
            "aws.kinesis.on_demand_retrieval_price_per_gb" => PricedValue::scalar(3.0, "USD"),
            "aws.kinesis.on_demand_stream_hour_price" => PricedValue::scalar(1.0, "USD"),
            "aws.lambda.request_price" => PricedValue::scalar(2.0, "USD"),
            "aws.lambda.gb_second" => PricedValue::scalar(1.0, "USD"),
            "aws.lambda.free_tier_requests" => PricedValue::scalar(10.0, "USD"),
            "aws.lambda.free_tier_gb_seconds" => PricedValue::scalar(20.0, "USD"),
            "aws.nat_gateway.hourly_price" => PricedValue::scalar(1.0, "USD"),
            "aws.nat_gateway.data_processing_price_per_gb" => PricedValue::scalar(2.0, "USD"),
            "aws.opensearch_serverless.ocu_hour_price" => PricedValue::scalar(1.0, "USD"),
            "aws.opensearch_serverless.storage_price_per_gb" => PricedValue::scalar(2.0, "USD"),
            "aws.route53.hosted_zone_month_price" => PricedValue::scalar(5.0, "USD"),
            "aws.route53.query_price_per_million" => PricedValue::scalar(1_000_000.0, "USD"),
            "aws.s3.put_request_price" => PricedValue::scalar(2.0, "USD"),
            "aws.s3.get_request_price" => PricedValue::scalar(3.0, "USD"),
            "aws.s3.storage_tiers" => free_then(100.0, 1.0),
            "aws.secrets_manager.secret_month_price" => PricedValue::scalar(5.0, "USD"),
            "aws.secrets_manager.api_call_price_per_10k" => PricedValue::scalar(10_000.0, "USD"),
            "aws.sns.delivery_price_per_million" => PricedValue::scalar(1_000_000.0, "USD"),
            "aws.sns.free_tier_deliveries" => PricedValue::scalar(10.0, "USD"),
            "aws.sqs.standard_request_price" => PricedValue::scalar(1.0, "USD"),
            "aws.sqs.fifo_request_price" => PricedValue::scalar(2.0, "USD"),
            "aws.sqs.free_tier_requests" => PricedValue::scalar(10.0, "USD"),
            "aws.step_functions.standard_transition_price" => PricedValue::scalar(2.0, "USD"),
            "aws.step_functions.express_request_price" => PricedValue::scalar(3.0, "USD"),
            "aws.step_functions.express_duration_price_per_gb_second" => {
                PricedValue::scalar(2.0, "USD")
            }
            "aws.step_functions.free_tier_transitions" => PricedValue::scalar(10.0, "USD"),
            "aws.waf.web_acl_month_price" => PricedValue::scalar(5.0, "USD"),
            "aws.waf.rule_month_price" => PricedValue::scalar(2.0, "USD"),
            "aws.waf.request_price_per_million" => PricedValue::scalar(1_000_000.0, "USD"),
            sku if sku.starts_with("aws.documentdb_storage.") => PricedValue::scalar(2.0, "USD"),
            sku if sku.starts_with("aws.documentdb.") => PricedValue::scalar(1.0, "USD"),
            sku if sku.starts_with("aws.ec2.instance.") => PricedValue::scalar(1.0, "USD"),
            sku if sku.starts_with("aws.elasticache.") => PricedValue::scalar(1.0, "USD"),
            sku if sku.starts_with("aws.msk_storage.") => PricedValue::scalar(2.0, "USD"),
            sku if sku.starts_with("aws.msk.") => PricedValue::scalar(1.0, "USD"),
            sku if sku.starts_with("aws.opensearch_service_storage.") => {
                PricedValue::scalar(2.0, "USD")
            }
            sku if sku.starts_with("aws.opensearch_service.") => PricedValue::scalar(1.0, "USD"),
            sku if sku.starts_with("aws.rds_storage.") => PricedValue::scalar(2.0, "USD"),
            // gp3 storage / iops unit prices must be listed before the
            // generic aws.rds.* prefix-catch-all below.
            "aws.rds.gp3_storage_gb_month" => PricedValue::scalar(0.1216, "USD"),
            "aws.rds.gp3_iops_month" => PricedValue::scalar(0.008, "USD"),
            sku if sku.starts_with("aws.rds.") => PricedValue::scalar(1.0, "USD"),
            sku if sku.starts_with("aws.redshift.") => PricedValue::scalar(1.0, "USD"),
            other => {
